...
import AddWaiterButtons from 'components/molecules/Employees/Waiter/AddWaiterButtons/index';
            ...
            <Grid templateColumns="repeat(2, 1fr)" gap={2} w="100%">
              ...
              <Box>
                <Input
                  ...
                  {...register('nameWaiter', { required: 'Wprowadź imię oraz nazwisko' })}
                />
                {errors.nameWaiter && (
                  <Box fontSize={breakpointsFontSize} color="red">
                    {errors.nameWaiter.message}
                  </Box>
                )}
              </Box>
            </Grid>
