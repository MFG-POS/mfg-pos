...
import { ROUTE_ACCESS, ROUTE_MENU, ROUTE_ORDERS, ROUTE_SETTINGS, ROUTE_STATS, ROUTE_WAREHOUSE } from 'routing';
...
const SidebarNav = () => (
  <>
    <Accordion allowToggle w="100%" flexGrow={1} as="nav">
      <NavGroup title="Zamówienia" links={Object.values(ROUTE_ORDERS)} icon={FaShoppingCart} />
